            ...
            <div class="ln-page-header__content">
                <div class="uk-container uk-container-center">
                    <div class="ln-page-header__breadcrumb">
                        ...
                        <span class="current-page">Bất Động Sản</span>
                    </div>
        ...
        <section class="ln-floorplan">
            <div class="uk-container uk-container-center">
                <div class="uk-text-center" style="margin-bottom:50px;">
                    ...
                    <p class="ln-section-desc" style="margin:0 auto;text-align:center;" data-reveal="up">Mỗi tầng được thiết
                        kế thông minh, tối ưu không gian sống và ánh sáng tự nhiên.</p>
                </div>
